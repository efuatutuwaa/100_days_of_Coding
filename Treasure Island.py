...
if choice_1 == "left":
    ...
    if choice_2 == "wait":
        ...
        if choice_3 == "yellow":
            ...
            print("You entered a room on fire 🔥. Game Over ⛔️")
        elif choice_3 == "blue":
            print("Yikes! You get eaten by a beast 👺. Game Over ⛔️")
    else:
        print("Attacked by a shark 🦈. Game Over ⛔️")
else:
    print("You fall into a 🕳. Game Over ⛔️")